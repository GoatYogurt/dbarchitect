...
interface DbmlEditorProps {
  value: string; // the current DBML code to display in the editor
...
export function DbmlEditor({ value, onChange, onSave, onToggleCollapse, isSaving = false, canSave = false }: DbmlEditorProps) {
