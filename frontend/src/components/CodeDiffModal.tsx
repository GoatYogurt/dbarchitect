...
export function CodeDiffModal({ isOpen, onClose, changes, isLoading = false }: CodeDiffModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-slate-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[85vh] flex flex-col border border-slate-700">
        {/* Header */}
